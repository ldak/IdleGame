...
public class OverHeat extends JFrame {

	private JPanel contentPane;
	public static int width=600;
	public static int height=500;
	private String message="You are this close to your desire,"
			+ "but you over heat the earth and now everything is dying."
			+ "It's too hot even for you. You start melting.";
	/**
	 * Create the frame.
	 */
	public OverHeat(int x, int y) {
