...
public class GoMoney extends JFrame {

	private JPanel contentPane;
	public static int width=600;
	public static int height=500;

	private String message = "YOU WARM THE EARTH \n \n"
			+ "Now everybody is happy. The economy is growing enormously."
			+ " You just need some more money and you will rest undisturbed";

	/**
	 * Create the frame.
	 */
	public GoMoney(int x, int y) {
	...
	private void drawPole(Graphics g) {
		...
		// Pole
		g.setColor(new Color(50, 150, 55));
		...
		g.setColor(new Color(55, 255, 55));
